  ...
  return (
    <div className="max-w-[500px] h-fit border m-auto rounded-md p-6 mt-6">
      <form onSubmit={handleSubmit} >
        ...
        <input ref={emailRef} className=' w-full p-2 rounded-md outline-none border  bg-gray-50 mt-8 mb-3 focus:border-green-500' type="email" autoComplete='true' placeholder='Email Address'/>
        <input ref={passwordRef} className='w-full p-2 rounded-md outline-none border  bg-gray-50 mb-3  focus:border-green-500' type="password" autoComplete='true' placeholder='Enter Password'/>
        <input ref={passwordConfirmRef} id="passwordConfirm" className='w-full p-2 rounded-md outline-none border bg-gray-50 mb-3  focus:border-green-500' type="password" autoComplete='true' placeholder='Confirm Password'/>
        <button disabled={loading}  className={loading ? `${style} bg-slate-400` : style}  >SIGN UP</button>
